-- Gerando relatorios com consultas,
--fazendo consultas menores pra depois
--fazer a consulta com todos os dados
...
round(((AUX1.QUANTIDADE_MES / AUX1.[VOLUME DE COMPRA])-1)*100,2) AS [VARIAÇÃO_PORCENTAGEM],
CASE WHEN AUX1.QUANTIDADE_MES <= AUX1.[VOLUME DE COMPRA] THEN 'VENDA VÁLIDA'
WHEN AUX1.QUANTIDADE_MES > AUX1.[VOLUME DE COMPRA] THEN 'VENDA INVÁLIDA'
END AS STATUS_VENDA
FROM
