CREATE PROCEDURE [dbo].[TratarErroZeroTry] @CPF VARCHAR(12), @ANO INT, @DENOMINADOR INT,
...
EXEC TratarErroZeroTry @CPF = @CPF, @ANO = @ANO, @DENOMINADOR = @DENOMINADOR, @MENSAGEM = @MENSAGEM OUTPUT
